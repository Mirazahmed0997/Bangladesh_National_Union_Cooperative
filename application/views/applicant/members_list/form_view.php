...
<body>
    ...
    <div class="content-wrapper page">
        ...
        <table>
            ...
            <tr>
                <td class="label">মোবাইল নম্বর ও ই-মেইল</td>
                <td><?= $member->i_contact ?>, <?= $member->i_email ?></td>
        ...
        <div class="row footer-sign">
            ...
            <div class="col-4">
                <div class="line"></div>
                <p>যাচাই ও অনুমোদন</p>
                <p>সম্পাদক / ব্যবস্থাপক</p>
            </div>

            <div class="col-4">
                <div class="line"></div>
                <p>অপারেটর</p>
                <p>রাজস্ব আদায় অফিসার</p>
            </div>
         ...
         <div class="footer">
            ...
            <div class="text-center">
                ...
                ইউনিয়নের ই-মেইলঃ "bjsuxyz892323@gmail.com"
                মোবাইলঃ "01700000000" । হালনাগাদ তথ্য দেখার জন্য ইউনিয়ন এর ওয়েবসাইট লগইন করুন : <a class="text-white" href="https://bjsucoop.org/">https://bjsucoop.org/</a>
            </p>
            </div>
            <div>
